...
if command -v python3 &> /dev/null; then
    ...
    sleep 2 && (xdg-open http://localhost:8000/diagrams_viewer_simple.html 2>/dev/null || \
                open http://localhost:8000/diagrams_viewer_simple.html 2>/dev/null || \
                start http://localhost:8000/diagrams_viewer_simple.html 2>/dev/null || \
                echo "Please open http://localhost:8000/diagrams_viewer_simple.html in your browser") &
